(function (root, factory) {
  ...
  function MusicMinigame$onAfterStarted$lambda$lambda(this$MusicMinigame, closure$soundController) {
    return function () {
      ...
      distortion.addEventListener('click', MusicMinigame$onAfterStarted$lambda$lambda$lambda_3(closure$soundController, this$MusicMinigame));
      var delay = Kotlin.isType(tmp$_4 = ensureNotNull(lastStateElement().querySelector('.music-delay')), HTMLElement) ? tmp$_4 : throwCCE();
      delay.addEventListener('click', MusicMinigame$onAfterStarted$lambda$lambda$lambda_4(closure$soundController, this$MusicMinigame));
