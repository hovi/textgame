(function (root, factory) {
  ...
  SuperStateBuilder.prototype.build = function () {
    ...
    if (this.finalTargetId == null && this.currentStateBuilder().moveIds.isEmpty()) {
      throw new StateException(this.id, 'Superuzel pot\u0159ebuje c\xEDl anebo hrany');
    }
  ...
  SuperStateBuilder.prototype.copy_1eqi67$ = function (id, currentTheme, selfConsuming, finalTargetId, chapterId, tmpStates) {
  ...
  function BinaryOperator$PLUS() {
    ...
    BinaryOperator.call(this, 'PLUS', 0);
  }
  ...
  function BinaryOperator$MINUS() {
    ...
    BinaryOperator.call(this, 'MINUS', 1);
  }
  ...
  function BinaryOperator$TIMES() {
    ...
    BinaryOperator.call(this, 'TIMES', 2);
  }
  ...
  function BinaryOperator$values() {
    return [BinaryOperator$PLUS_getInstance(), BinaryOperator$MINUS_getInstance(), BinaryOperator$TIMES_getInstance(), BinaryOperator$NONE_getInstance()];
  }
  ...
  function MathExpression$Companion() {
    ...
    this.simpleMath = Regex_init('([0-9]+|[+\\-*])');
    this.value = Regex_init('([0-9]+)');
  ...
  MathExpression.prototype.evaluate = function () {
    ...
    if (MathExpression$Companion_getInstance().math.matches_6bul2c$($receiver)) {
      ...
      var tmp$;
      tmp$ = MathExpression$Companion_getInstance().simpleMath.findAll_905azu$(this.expression).iterator();
      while (tmp$.hasNext()) {
        var element = tmp$.next();
        var valueOrOperator = ensureNotNull(element.groups.get_za3lpa$(1)).value;
        if (MathExpression$Companion_getInstance().value.matches_6bul2c$(valueOrOperator)) {
          if (isNaN_0(floatResult.v)) {
            floatResult.v = toDouble(valueOrOperator);
          }
           else {
            floatResult.v = lastOperator.v.evaluate_dleff0$(floatResult.v, toDouble(valueOrOperator));
            lastOperator.v === BinaryOperator$NONE_getInstance();
          }
        }
         else {
          if (MathExpression$Companion_getInstance().operator.matches_6bul2c$(valueOrOperator)) {
            lastOperator.v = BinaryOperator$Companion_getInstance().parse_61zpoe$(valueOrOperator);
          }
        }
      }
  ...
  MathExpression.prototype.copy_61zpoe$ = function (expression) {
    return new MathExpression(expression === void 0 ? this.expression : expression);
  };
  MathExpression.prototype.toString = function () {
    return 'MathExpression(expression=' + Kotlin.toString(this.expression) + ')';
  };
  ...
  VariableContainer.prototype.evaluate_61zpoe$ = function (expression) {
    ...
    if (MathExpression$Companion_getInstance().isExpression_61zpoe$(result)) {
      return numberToInt((new MathExpression(result)).evaluate()).toString();
    }
    return result;
  };
  ...
  function SoundController() {
    ...
    this.solo = new TrackGroup([new AudioTrack('melodie1_cista', void 0, void 0, void 0, void 0, this.callback), new AudioTrack('melodie2_original', void 0, void 0, void 0, void 0, this.callback), new AudioTrack('melodie3', void 0, void 0, void 0, void 0, this.callback), new AudioTrack('melodie_tap', void 0, void 0, void 0, void 0, this.callback)]);
    this.rhythm = new TrackGroup([new AudioTrack('doprovod_rozlozene', true, void 0, void 0, false, this.callback), new AudioTrack('doprovod_delay', true, void 0, void 0, false, this.callback), new AudioTrack('doprovod_sekany_akordy', true, void 0, void 0, false, this.callback)]);
    this.drums = new TrackGroup([new AudioTrack('bici1', true, 1.0, void 0, false, this.callback), new AudioTrack('bici2', true, 1.0, void 0, false, this.callback)]);
  ...
  function MusicMinigame$onAfterStarted$lambda$lambda$lambda(closure$soundController, this$MusicMinigame) {
    return function (it) {
      ...
      closure$soundController.group.stop();
      delete window.group;
      delete window.soundController;
      delete window.Pizzicato;
      this$MusicMinigame.newFlags.add_11rb$(random_0(this$MusicMinigame.allNewFlags));
      this$MusicMinigame.fireFinish();
      return Unit;
    };
  }
  function MusicMinigame$onAfterStarted$lambda$lambda$lambda_0(closure$soundController, this$MusicMinigame) {
    return function (it) {
  ...
  function MusicMinigame$onAfterStarted$lambda$lambda(this$MusicMinigame, closure$soundController) {
    return function () {
      ...
      bejk.addEventListener('click', MusicMinigame$onAfterStarted$lambda$lambda$lambda_0(closure$soundController, this$MusicMinigame));
      var celi = Kotlin.isType(tmp$_1 = ensureNotNull(lastStateElement().querySelector('.muzikant.celi')), HTMLElement) ? tmp$_1 : throwCCE();
      celi.addEventListener('click', MusicMinigame$onAfterStarted$lambda$lambda$lambda_1(closure$soundController, this$MusicMinigame));
      var kodzin = Kotlin.isType(tmp$_2 = ensureNotNull(lastStateElement().querySelector('.muzikant.kodzin')), HTMLElement) ? tmp$_2 : throwCCE();
      kodzin.addEventListener('click', MusicMinigame$onAfterStarted$lambda$lambda$lambda_2(closure$soundController, this$MusicMinigame));
