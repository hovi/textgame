(function (root, factory) {
  ...
  Game.prototype.move_8hvgvt$ = function (move) {
    ...
    if (!this.gameConfigHelper.containsState_61zpoe$(move.targetId) && move.acrossChapters()) {
      println('Missing target: ' + move.targetId);
  ...
  Options.prototype.copy_6p5q91$ = function (path, loop, volume) {
  ...
  function SoundController() {
    ...
    this.solo = new TrackGroup([new AudioTrack('melodie1_cista.ogg', void 0, void 0, void 0, void 0, this.callback), new AudioTrack('melodie2.ogg', void 0, void 0, void 0, void 0, this.callback), new AudioTrack('melodie3.ogg', void 0, void 0, void 0, void 0, this.callback)]);
    this.rhythm = new TrackGroup([new AudioTrack('doprovod_cisty.ogg', true, void 0, void 0, void 0, this.callback), new AudioTrack('doprovod_delay.ogg', true, void 0, void 0, void 0, this.callback), new AudioTrack('doprovod_sekany_akordy.ogg', true, void 0, void 0, void 0, this.callback)]);
    this.drums = new TrackGroup([new AudioTrack('bici1.ogg', true, 0.2, void 0, false, this.callback), new AudioTrack('bici2.ogg', true, 0.2, void 0, false, this.callback)]);
  ...
  SoundController.prototype.load = function (finishedCallback) {
    this.mainCallback = finishedCallback;
    var tmp$;
    tmp$ = this.trackGroups.values.iterator();
    while (tmp$.hasNext()) {
      var element = tmp$.next();
  ...
  function SoundController$callback$lambda(this$SoundController) {
    return function () {
      ...
      println('done: ' + this$SoundController.finished);
