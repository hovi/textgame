(function (root, factory) {
  ...
  function Move(id, caption, image, illustration, text, selfConsuming, targetId, flags, flagsRequired, flagsDisallowing, categories, theme, variables, background) {
    if (caption === void 0)
      caption = null;
    if (image === void 0)
      image = null;
  ...
  function State(id, text, illustration, chapterId, flags, moves, categories, endType, theme, background, minigame, variables, checkpoint) {
    if (text === void 0)
      text = null;
    if (illustration === void 0)
      illustration = null;
  ...
  function parameterVariable($receiver) {
    var string = $receiver;
    if (GameConverter$Companion_getInstance().PROMENNA.matches_6bul2c$(string)) {
      var variableName = GameConverter$Companion_getInstance().PROMENNA.replace_x2uqeu$(string, '$1');
      var operator = GameConverter$Companion_getInstance().PROMENNA.replace_x2uqeu$(string, '$2');
      var expression = GameConverter$Companion_getInstance().PROMENNA.replace_x2uqeu$(string, '$3');
      if (equals(operator, '+=')) {
  ...
  function MoveBuilder(gameConverterContext, id, caption, image, illustration, text, selfConsuming, targetId, flags, flagsRequired, flagsDisallowing, categories, theme, variables, background) {
  ...
  MoveBuilder.prototype.build = function () {
    ...
    if ((tmp$_3 = this.text) != null) {
      ...
      tmp$_4 = null;
    return new Move(tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_4, this.selfConsuming, ensureNotNull(this.targetId), copyToArray(this.flags), copyToArray(this.flagsRequired), copyToArray(this.flagsDisallowing), this.categories, this.theme, copyToArray(this.variables), this.background);
  };
  ...
  MoveBuilder.prototype.copy_971zv7$ = function (gameConverterContext, id, caption, image, illustration, text, selfConsuming, targetId, flags, flagsRequired, flagsDisallowing, categories, theme, variables, background) {
  ...
  function StateBuilder(gameConverterContext, id, illustration, text_, flags, moveIds, chapterId, categories, endType, theme, background, minigame, variables, moves, checkpoint, selfConsuming) {
    if (id === void 0)
      id = null;
    if (illustration === void 0)
      illustration = null;
  ...
  StateBuilder.prototype.build_pdl1vj$ = function (nextStateId) {
    ...
    return new State(tmp$, tmp$_1, tmp$_0, tmp$_2, tmp$_3, copyToArray(destination), this.categories, this.endType, this.theme, this.background, this.minigame, copyToArray(this.variables), this.checkpoint);
  };
  ...
  function GameConfigHelper(gameConfig) {
    ...
    var destination_2 = ArrayList_init($receiver_3.size);
    var tmp$_12;
