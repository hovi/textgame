(function (root, factory) {
  ...
  SuperStateBuilder.prototype.build_pdl1vj$ = function (next) {
    ...
    var tmp$_1 = this.finalTargetId != null;
    if (tmp$_1) {
      tmp$_1 = !this.currentStateBuilder().moves.isEmpty();
    }
    if (tmp$_1) {
    ...
    while (tmp$.hasNext()) {
      ...
      if (index === (this.tmpStates.size - 1 | 0)) {
        tmp$_0 = stateBuilder.build_pdl1vj$(next);
      }
       else {
        tmp$_0 = stateBuilder.build_pdl1vj$(nextStateId);
      }
      var state = tmp$_0;
  ...
  SuperStateBuilder.prototype.addState = function () {
    ...
    this.tmpStates.add_11rb$(new StateBuilder(this.gameConverterContext, stateId, void 0, void 0, void 0, void 0, this.chapterId, this.currentCategories, void 0, this.currentTheme, this.currentBackground));
    return stateId;
  };
