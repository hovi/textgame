(function (root, factory) {
  ...
  GameConfig$Companion.prototype.fromStates_duu6qb$ = function (states) {
    ...
    var chapter = new Chapter(firstState.chapterId, firstState.chapterId);
  ...
  function Move(id, caption, image, illustration, text, selfConsuming, targetId, flags, flagsRequired, flagsDisallowing, categories, theme, variables, background, pause) {
    if (caption === void 0)
      caption = null;
    if (image === void 0)
      image = null;
  ...
  Move.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.id, other.id) && Kotlin.equals(this.caption, other.caption) && Kotlin.equals(this.image, other.image) && Kotlin.equals(this.illustration, other.illustration) && Kotlin.equals(this.text, other.text) && Kotlin.equals(this.selfConsuming, other.selfConsuming) && Kotlin.equals(this.targetId, other.targetId) && Kotlin.equals(this.flags, other.flags) && Kotlin.equals(this.flagsRequired, other.flagsRequired) && Kotlin.equals(this.flagsDisallowing, other.flagsDisallowing) && Kotlin.equals(this.categories, other.categories) && Kotlin.equals(this.theme, other.theme) && Kotlin.equals(this.variables, other.variables) && Kotlin.equals(this.background, other.background) && Kotlin.equals(this.pause, other.pause)))));
  };
  ...
  function State(id, text, illustration, chapterId, flags, moves, categories, endType, theme, background, minigame, variables, checkpoint, random, pause) {
    if (text === void 0)
      text = null;
    if (illustration === void 0)
      illustration = null;
  ...
  State.prototype.usePause_tfme49$ = function (filteredMoves) {
    ...
    switch (this.pause.name) {
      case 'AUTO':
        tmp$ = (this.hasContent() && this.endType === EndType$NONE_getInstance() && isNotInteractive_0(filteredMoves));
        break;
      case 'NO':
        tmp$ = false;
        break;
  ...
  function parse($receiver, text) {
    ...
    while (tmp$.hasNext()) {
      ...
      try {
        var tmp$_0;
        $receiver.parseLine_bm4lxs$(replace(trim(Kotlin.isCharSequence(tmp$_0 = line) ? tmp$_0 : throwCCE()).toString(), '-&gt;', '->'), index);
      }
       catch (e) {
    ...
    if (!startsWith(line, '#'))
      if (!equals(line, '') && !equals(line, GameConverter$Companion_getInstance().SEPARATOR)) {
        if (GameConverter$Companion_getInstance().SUPERUZEL.matches_6bul2c$(line)) {
          ...
          this.currentSuperState_0 = new SuperStateBuilder(this.converterContext, id, void 0, void 0, void 0, void 0, void 0, ensureNotNull(this.currentChapter_0).id);
  ...
  function GameConverter$Companion() {
    ...
    this.NAHODNY = Regex_init('nahodny=(ano|ne)');
  }
  ...
  function MoveBuilder(gameConverterContext, id, caption, image, illustration, text, selfConsuming, targetId, flags, flagsRequired, flagsDisallowing, categories, theme, variables, background, pause) {
                ...
                if (GameConverter$Companion_getInstance().KATEGORIE.matches_6bul2c$(line)) {
                  ...
                  if (GameConverter$Companion_getInstance().ILUSTRACE.matches_6bul2c$(line)) {
                    ...
                    if (GameConverter$Companion_getInstance().OBRAZEK.matches_6bul2c$(line)) {
                      ...
                      if (GameConverter$Companion_getInstance().VYLOUCENA.matches_6bul2c$(line)) {
                        addAll(this.flagsDisallowing, parameterArray(line));
                      }
                       else {
                        if (GameConverter$Companion_getInstance().PODMINENA.matches_6bul2c$(line)) {
                          addAll(this.flagsRequired, parameterArray(line));
                        }
                         else {
                          if (GameConverter$Companion_getInstance().POPIS.matches_6bul2c$(line)) {
  ...
  MoveBuilder.prototype.build = function () {
    ...
    if ((tmp$_3 = this.text) != null) {
      ...
      tmp$_4 = null;
    return new Move(tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_4, this.selfConsuming, ensureNotNull(this.targetId), copyToArray(this.flags), copyToArray(this.flagsRequired), copyToArray(this.flagsDisallowing), this.categories, this.theme, copyToArray(this.variables), this.background, this.pause);
  };
  ...
  MoveBuilder.prototype.copy_zig7mb$ = function (gameConverterContext, id, caption, image, illustration, text, selfConsuming, targetId, flags, flagsRequired, flagsDisallowing, categories, theme, variables, background, pause) {
  ...
  MoveBuilder.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.gameConverterContext, other.gameConverterContext) && Kotlin.equals(this.id, other.id) && Kotlin.equals(this.caption, other.caption) && Kotlin.equals(this.image, other.image) && Kotlin.equals(this.illustration, other.illustration) && Kotlin.equals(this.text, other.text) && Kotlin.equals(this.selfConsuming, other.selfConsuming) && Kotlin.equals(this.targetId, other.targetId) && Kotlin.equals(this.flags, other.flags) && Kotlin.equals(this.flagsRequired, other.flagsRequired) && Kotlin.equals(this.flagsDisallowing, other.flagsDisallowing) && Kotlin.equals(this.categories, other.categories) && Kotlin.equals(this.theme, other.theme) && Kotlin.equals(this.variables, other.variables) && Kotlin.equals(this.background, other.background) && Kotlin.equals(this.pause, other.pause)))));
  };
  function StateBuilder(gameConverterContext, id, illustration, text_, flags, moveIds, chapterId, categories, endType, theme, background, minigame, variables, moves, checkpoint, selfConsuming, random, pause) {
    if (id === void 0)
      id = null;
    if (illustration === void 0)
      illustration = null;
      ...
      if (GameConverter$Companion_getInstance().PAUZA.matches_6bul2c$(line)) {
        ...
        if (GameConverter$Companion_getInstance().PROMENNA.matches_6bul2c$(line)) {
          ...
          if (GameConverter$Companion_getInstance().PRIZNAK.matches_6bul2c$(line)) {
            ...
            if (GameConverter$Companion_getInstance().NAHODNY.matches_6bul2c$(line)) {
              this.random = parameterBoolean(line);
            }
             else {
              if (GameConverter$Companion_getInstance().POZIRACI.matches_6bul2c$(line)) {
                this.selfConsuming = parameterBoolean(line);
                ...
                if (GameConverter$Companion_getInstance().MINIHRA.matches_6bul2c$(line)) {
                  ...
                  if (GameConverter$Companion_getInstance().POZADI.matches_6bul2c$(line)) {
                    ...
                    if (GameConverter$Companion_getInstance().CHECKPOINT.matches_6bul2c$(line)) {
                      ...
                      if (GameConverter$Companion_getInstance().TEMA.matches_6bul2c$(line)) {
                        ...
                        if (GameConverter$Companion_getInstance().CIL.matches_6bul2c$(line)) {
                          ...
                          this.moves.add_11rb$(new MoveBuilder(this.gameConverterContext, moveId, void 0, void 0, void 0, void 0, (tmp$ = this.selfConsuming) != null ? tmp$ : SuperStateBuilder$Companion_getInstance().NODE_SELF_CONSUMING, targetId, void 0, void 0, void 0, this.categories, void 0, void 0, this.background));
                        }
                         else {
  ...
  StateBuilder.prototype.addMove_pdl1vj$ = function (moveId) {
    if (moveId === void 0)
      moveId = null;
    var tmp$;
    var moveBuilder = new MoveBuilder(this.gameConverterContext, moveId, void 0, void 0, void 0, void 0, (tmp$ = this.selfConsuming) != null ? tmp$ : MoveBuilder$Companion_getInstance().DEFAULT_SELF_CONSUMING, void 0, void 0, void 0, void 0, this.categories, void 0, void 0, this.background);
  ...
  StateBuilder.prototype.build_pdl1vj$ = function (nextStateId) {
    ...
    return new State(tmp$, tmp$_1, tmp$_0, tmp$_2, tmp$_3, copyToArray(destination), this.categories, this.endType, this.theme, this.background, this.minigame, copyToArray(this.variables), this.checkpoint, this.random, this.pause);
  };
  ...
  StateBuilder.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.gameConverterContext, other.gameConverterContext) && Kotlin.equals(this.id, other.id) && Kotlin.equals(this.illustration, other.illustration) && Kotlin.equals(this.text__0, other.text__0) && Kotlin.equals(this.flags, other.flags) && Kotlin.equals(this.moveIds, other.moveIds) && Kotlin.equals(this.chapterId, other.chapterId) && Kotlin.equals(this.categories, other.categories) && Kotlin.equals(this.endType, other.endType) && Kotlin.equals(this.theme, other.theme) && Kotlin.equals(this.background, other.background) && Kotlin.equals(this.minigame, other.minigame) && Kotlin.equals(this.variables, other.variables) && Kotlin.equals(this.moves, other.moves) && Kotlin.equals(this.checkpoint, other.checkpoint) && Kotlin.equals(this.selfConsuming, other.selfConsuming) && Kotlin.equals(this.random, other.random) && Kotlin.equals(this.pause, other.pause)))));
  };
  function SuperStateBuilder(gameConverterContext, id, currentTheme, currentBackground, currentCategories, selfConsuming, finalTargetId, chapterId, tmpStates, endType) {
  ...
  SuperStateBuilder.prototype.build_pdl1vj$ = function (next) {
    ...
    var tmp$_3 = this.finalTargetId != null;
    if (tmp$_3) {
      tmp$_3 = !this.currentStateBuilder().moves.isEmpty();
    }
    if (tmp$_3) {
      ...
      if (stateBuilder.moves.isEmpty()) {
        ...
        if (nextState == null) {
          if (this.finalTargetId != null) {
            stateBuilder.moves.add_11rb$(new MoveBuilder(this.gameConverterContext, moveId, void 0, void 0, void 0, void 0, this.selfConsuming, ensureNotNull(this.finalTargetId), void 0, void 0, void 0, this.currentCategories, void 0, void 0, this.currentBackground));
          }
          ...
          stateBuilder.moves.add_11rb$(new MoveBuilder(this.gameConverterContext, moveId, void 0, void 0, void 0, void 0, this.selfConsuming, nextStateId, void 0, void 0, void 0, this.currentCategories, void 0, void 0, this.currentBackground));
        }
      }
      if (nextState == null) {
        tmp$_2 = stateBuilder.build_pdl1vj$(next);
      }
       else {
        tmp$_2 = stateBuilder.build_pdl1vj$(nextStateId);
      }
      var state = tmp$_2;
  ...
  SuperStateBuilder.prototype.addState_pdl1vj$ = function (stateId) {
    ...
    this.tmpStates.add_11rb$(new StateBuilder(this.gameConverterContext, newStateId, void 0, void 0, void 0, void 0, this.chapterId, this.currentCategories, void 0, this.currentTheme, this.currentBackground, void 0, void 0, void 0, void 0, this.selfConsuming));
    return newStateId;
  };
  ...
  SuperStateBuilder.prototype.copy_tofoiy$ = function (gameConverterContext, id, currentTheme, currentBackground, currentCategories, selfConsuming, finalTargetId, chapterId, tmpStates, endType) {
  ...
  function GameConfigHelper(gameConfig) {
    ...
    this.movesByTargetId_0 = LinkedHashMap_init();
    this.flagGroups = ArrayList_init();
    var tmp$_2, tmp$_3, tmp$_4, tmp$_5, tmp$_6, tmp$_7, tmp$_8, tmp$_9, tmp$_10, tmp$_11;
    tmp$_2 = this.gameConfig.moves;
    for (tmp$_3 = 0; tmp$_3 !== tmp$_2.length; ++tmp$_3) {
      var move = tmp$_2[tmp$_3];
      if (this.movesByTargetId_0.containsKey_11rb$(move.targetId)) {
        ensureNotNull(this.movesByTargetId_0.get_11rb$(move.targetId)).add_11rb$(move);
      }
       else {
        var $receiver_2 = this.movesByTargetId_0;
        var key = move.targetId;
        var value = mutableListOf([move]);
    ...
    var tmp$_12;
    tmp$_12 = $receiver_3.entries.iterator();
    ...
    while (tmp$_13.hasNext()) {
      ...
      var tmp$_14;
      for (tmp$_14 = 0; tmp$_14 !== element_2.length; ++tmp$_14) {
        var flagGroup = element_2[tmp$_14];
        this.flagGroups.add_11rb$(flagGroup);
      }
    }
    tmp$_4 = this.gameConfig.states;
    for (tmp$_5 = 0; tmp$_5 !== tmp$_4.length; ++tmp$_5) {
      var state = tmp$_4[tmp$_5];
      if (this.flagGroupsByStateId_0.get_11rb$(state.id) == null) {
        var tmp$_15 = this.flagGroupsByStateId_0;
        var tmp$_16 = state.id;
        var value_0 = ArrayList_init();
        tmp$_15.put_xwzc9p$(tmp$_16, value_0);
      }
      tmp$_6 = state.moves;
      for (tmp$_7 = 0; tmp$_7 !== tmp$_6.length; ++tmp$_7) {
        var move_0 = tmp$_6[tmp$_7];
        tmp$_8 = move_0.flagsDisallowing;
        for (tmp$_9 = 0; tmp$_9 !== tmp$_8.length; ++tmp$_9) {
          var flag = tmp$_8[tmp$_9];
        ...
        tmp$_10 = move_0.flagsRequired;
        for (tmp$_11 = 0; tmp$_11 !== tmp$_10.length; ++tmp$_11) {
          var flag_0 = tmp$_10[tmp$_11];
  ...
  GameValidator.prototype.validateMove_0 = function (move, ignoreAcrossChapters) {
    ...
    for (tmp$_0 = 0; tmp$_0 !== tmp$.length; ++tmp$_0) {
      var flag = tmp$[tmp$_0];
      if (!isFlagBooleanExpression(flag) && !contains_0(this.flags, flag)) {
    ...
    for (tmp$_2 = 0; tmp$_2 !== tmp$_1.length; ++tmp$_2) {
      ...
      if (!isFlagBooleanExpression(flag_0) && !contains_0(this.flags, flag_0)) {
  ...
  GameValidator.prototype.validate = function () {
    ...
    if (!this.warningList.isEmpty()) {
      var firstWarning = first_0(this.warningList);
      ...
      throw IllegalArgumentException_init(first_0(this.warningList).toString());
    }
  };
