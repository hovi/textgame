(function (root, factory) {
  ...
  SmartRandom.prototype.nextInt_za3lpa$ = function (max) {
    var value = util.RandomUtil.nextInt_za3lpa$(max);
    var lastValue = this.lastRandomMap.get_11rb$(max);
    if (lastValue != null && lastValue === value) {
      value = util.RandomUtil.nextInt_za3lpa$(max);
    }
  ...
  SuperStateBuilder.prototype.copy_mqejet$ = function (id, currentTheme, currentBackground, selfConsuming, finalTargetId, chapterId, tmpStates, endType) {
  ...
  function GameConverter$ConvertState$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant eu.karelhovorka.textgame.core.builder.GameConverter.ConvertState.' + name);
    }
  }
            ...
            if (UZEL.matches_6bul2c$(line)) {
              ...
              if (this.HRANA_0.matches_6bul2c$(line)) {
                ...
                if (this.convertState_0 === GameConverter$ConvertState$SUPERNODE_getInstance()) {
                  if (equals(this.SUPERUZEL_SEPARATOR_0, line)) {
                    ...
                    if (this.KONEC_0.matches_6bul2c$(line)) {
                      ...
                      if (this.TEMA_0.matches_6bul2c$(line)) {
                        ...
                        this.parseNodeParameters_9y3bf8$(ensureNotNull(this.currentSuperState_0).currentStateBuilder(), line, index);
                      }
                       else {
                  ...
                  this.parseNodeParameters_9y3bf8$(ensureNotNull(this.currentState_0), line, index);
                }
  ...
  GameConverter.prototype.parseNodeParameters_9y3bf8$ = function (builder, line, index) {
  ...
  Object.defineProperty(package$builder, 'SmartRandom', {
    get: SmartRandom_getInstance
  });
  Object.defineProperty(package$builder, 'NODE_SELF_CONSUMING', {
    get: function () {
      return NODE_SELF_CONSUMING;
    }
  });
  package$builder.SuperStateBuilder = SuperStateBuilder;
  Object.defineProperty(package$builder, 'UZEL', {
    get: function () {
      return UZEL;
    }
  });
  package$builder.fixBOM_61zpoe$ = fixBOM;
