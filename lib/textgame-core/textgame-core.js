(function (root, factory) {
  ...
  function parameterArray($receiver) {
    checkParameter($receiver);
    var result = GameConverter$Companion_getInstance().PARAMETER.replace_x2uqeu$($receiver, '$2');
  ...
  function StateBuilder(gameConverterContext, id, illustration, text_, flags, moveIds, chapterId, categories, endType, theme, background, minigame, variables, moves, checkpoint) {
    if (id === void 0)
      id = null;
    if (illustration === void 0)
      illustration = null;
              ...
              if (GameConverter$Companion_getInstance().CHECKPOINT.matches_6bul2c$(line)) {
                ...
                if (GameConverter$Companion_getInstance().TEMA.matches_6bul2c$(line)) {
                  ...
                  if (GameConverter$Companion_getInstance().CIL.matches_6bul2c$(line)) {
                    ...
                    this.moves.add_11rb$(new MoveBuilder(this.gameConverterContext, moveId, void 0, void 0, void 0, void 0, SuperStateBuilder$Companion_getInstance().NODE_SELF_CONSUMING, targetId, void 0, void 0, void 0, this.categories, void 0, void 0, this.background));
                  }
                   else {
  ...
  StateBuilder.prototype.addMove_pdl1vj$ = function (moveId) {
    if (moveId === void 0)
      moveId = null;
    var moveBuilder = new MoveBuilder(this.gameConverterContext, moveId, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, this.categories, void 0, void 0, this.background);
  ...
  SuperStateBuilder.prototype.build_pdl1vj$ = function (next) {
    ...
    var tmp$_2 = this.finalTargetId != null;
    if (tmp$_2) {
      tmp$_2 = !this.currentStateBuilder().moves.isEmpty();
    }
    if (tmp$_2) {
    ...
    while (tmp$.hasNext()) {
      ...
      if (index === (this.tmpStates.size - 1 | 0)) {
        tmp$_0 = this.finalTargetId;
      }
       else {
        tmp$_0 = this.tmpStates.get_za3lpa$(index + 1 | 0).id;
      }
      var nextStateId = tmp$_0;
      ...
      if (index === (this.tmpStates.size - 1 | 0)) {
        tmp$_1 = stateBuilder.build_pdl1vj$(next);
      }
       else {
        tmp$_1 = stateBuilder.build_pdl1vj$(nextStateId);
      }
      var state = tmp$_1;
  ...
  SuperStateBuilder.prototype.addState_pdl1vj$ = function (stateId) {
    ...
    this.tmpStates.add_11rb$(new StateBuilder(this.gameConverterContext, newStateId, void 0, void 0, void 0, void 0, this.chapterId, this.currentCategories, void 0, this.currentTheme, this.currentBackground));
    return newStateId;
  };
